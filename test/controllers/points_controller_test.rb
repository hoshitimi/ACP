...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { fluctuation: @point.fluctuation, summary: @point.summary, user_id: @point.user_id } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { fluctuation: @point.fluctuation, summary: @point.summary, user_id: @point.user_id } }
