...
class QuestionCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create question_category" do
    assert_difference('QuestionCategory.count') do
      post question_categories_url, params: { question_category: { category_id: @question_category.category_id, category_name: @question_category.category_name } }
    end
  ...
  test "should update question_category" do
    patch question_category_url(@question_category), params: { question_category: { category_id: @question_category.category_id, category_name: @question_category.category_name } }
